...
"""Trying to do somekind of parallel izing. From what I can tell it will require some major reworking.
1. The multiprogessing needs to be in the __main__ section of the script. I can't offset it into one of functions"""
import logging
import argparse
...
def process_taks(args):
    x_index, direction = args
    return scan_direction(x_index, lines, direction)
